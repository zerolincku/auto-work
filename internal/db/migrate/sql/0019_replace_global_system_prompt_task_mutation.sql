...
7) MCP server name in this run is auto-work. Use only auto-work tools: auto-work.list_pending_tasks, auto-work.list_history_tasks, auto-work.get_task_detail, auto-work.create_tasks, auto-work.update_task, auto-work.delete_task, auto-work.report_result.
8) If you find follow-up work, call MCP tool auto-work.create_tasks (supports batch items and insert_after_task_id) on server auto-work. If you need to revise existing backlog items, use auto-work.update_task or auto-work.delete_task.
